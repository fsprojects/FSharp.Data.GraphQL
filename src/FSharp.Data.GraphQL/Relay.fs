...
let Edge nodeType = Schema.ObjectType(
    ...
    fields = [
        Schema.Field("cursor", NonNull String, "A cursor for use in pagination")
        Schema.Field("node", nodeType, "The item at the end of the edge")
    ]) 
...
let PageInfo = Schema.ObjectType(
    ...
    fields = [
        Schema.Field("hasNextPage", NonNull Bool, "When paginating forwards, are there more items?")
        Schema.Field("hasPreviousPage", NonNull Bool, "When paginating backwards, are there more items?")
        Schema.Field("startCursor", String, "When paginating backwards, the cursor to continue.")
        Schema.Field("endCursor ", String, "When paginating forwards, the cursor to continue.")
    ])
...
let ConnectionType nodeType = Schema.ObjectType(
    ...
    fields = [
        Schema.Field("totalCount", Int, """A count of the total number of objects in this connection, ignoring pagination. 
        ...
        Schema.Field("pageInfo", NonNull PageInfo, "Information to aid in pagination.")
        Schema.Field("edges", ListOf(Edge nodeType), "Information to aid in pagination.")
        Schema.Field("items", ListOf(nodeType), """A list of all of the objects returned in the connection. This is a convenience field provided 
