...
let __DirectiveLocation =
  Define.Enum(
    ...
    options = [
        ...
        Define.EnumValue("SCHEMA", DirectiveLocation.SCHEMA, "Indicates the directive is valid on a schema IDL definition.")
        Define.EnumValue("SCALAR", DirectiveLocation.SCALAR, "Indicates the directive is valid on a scalar IDL definition.")
        Define.EnumValue("OBJECT", DirectiveLocation.OBJECT, "Indicates the directive is valid on an object IDL definition.")
        Define.EnumValue("FIELD_DEFINITION", DirectiveLocation.FIELD_DEFINITION, "Indicates the directive is valid on a field IDL definition.")
        Define.EnumValue("ARGUMENT_DEFINITION", DirectiveLocation.ARGUMENT_DEFINITION, "Indicates the directive is valid on a field argument IDL definition.")
        Define.EnumValue("INTERFACE", DirectiveLocation.INTERFACE, "Indicates the directive is valid on an interface IDL definition.")
        Define.EnumValue("UNION", DirectiveLocation.UNION, "Indicates the directive is valid on an union IDL definition.")
        Define.EnumValue("ENUM", DirectiveLocation.ENUM, "Indicates the directive is valid on an enum IDL definition.")
        Define.EnumValue("ENUM_VALUE", DirectiveLocation.ENUM_VALUE, "Indicates the directive is valid on an enum value definition.")
        Define.EnumValue("INPUT_OBJECT", DirectiveLocation.INPUT_OBJECT, "Indicates the directive is valid on an input object IDL definition.")
        Define.EnumValue("INPUT_FIELD_DEFINITION", DirectiveLocation.INPUT_FIELD_DEFINITION, "Indicates the directive is valid on an input object field IDL definition.")
    ])
