...
module SchemaDefinitions =
    ...
    let IncludeDirective : DirectiveDef =
        { Name = "include"
          ...
          Locations =
              ExecutableDirectiveLocation.FIELD ||| ExecutableDirectiveLocation.FRAGMENT_SPREAD ||| ExecutableDirectiveLocation.INLINE_FRAGMENT
    ...
    let DeferDirective : DirectiveDef =
        { Name = "defer"
          ...
          Locations =
            ExecutableDirectiveLocation.FIELD ||| ExecutableDirectiveLocation.FRAGMENT_SPREAD ||| ExecutableDirectiveLocation.INLINE_FRAGMENT ||| ExecutableDirectiveLocation.FRAGMENT_DEFINITION
            |> ExecutableDirectiveLocation
          Args = [||] }
