...
module SchemaDefinitions =
    ...
    module Errors =
        ...
        type InputValue with
            ...
            member inputValue.GetCoerceError (destinationType) =
                let getMessage inputType value =
                    $"Inline value '{value}' of type %s{inputType} cannot be converted into %s{destinationType}"
                let message =
                    ...
                    | value ->
                        raise
                        <| NotSupportedException $"{value} cannot be passed as scalar input"
                Error [
                    {
                        new IGQLError with
            ...
            member inputValue.GetCoerceRangeError (destinationType, minValue, maxValue) =
                let getMessage inputType value =
                    $"Inline value '{value}' of type %s{inputType} cannot be converted into %s{destinationType} of range from {minValue} to {maxValue}"
                let message =
                    match inputValue with
                    | IntValue value -> getMessage "integer" value
                    | FloatValue value -> getMessage "float" value
                ...
                Error [
                    {
                        new IGQLError with
                            member _.Message =
                                $"JSON value '{jsonValue}' of kind '{e.ValueKind}' cannot be deserialized into %s{destinationType} of range from {minValue} to {maxValue}"
                    }
                ]
                ...
                Error [
                    {
                        new IGQLError with
                            member _.Message =
                                $"JSON value '{jsonValue}' of kind '{e.ValueKind}' cannot be deserialized into %s{destinationType}"
                    }
                ]
            ...
            Error [
                {
                    new IGQLError with
                        member _.Message =
                            $"Inline value '%s{value}' cannot be parsed into %s{destinationType} of range from {minValue} to {maxValue}"
                }
            ]
    ...
    let IncludeDirective : DirectiveDef = {
        Name = "include"
        Description = ValueSome "Directs the executor to include this field or fragment only when the `if` argument is true."
        Locations =
        ...
        Args = [|
            {
                ...
                Description = ValueSome "An optional label identifying the deferred payload."
                IsSkippable = false
    ...
    type Define =
        ...
        static member Scalar
            (name : string, coerceInput : InputParameterValue -> Result<'T, string>, coerceOutput : obj -> 'T option, [<Struct>] ?description : string) : ScalarDefinition<
                                                                                                                                                              'T
                                                                                                                                                           >
            = {
            Name = name
        ...
        static member Scalar
            (
                name : string,
                coerceInput : InputParameterValue -> Result<'T, string list>,
                coerceOutput : obj -> 'T option,
        ...
        static member Scalar
            (
                name : string,
                coerceInput : InputParameterValue -> Result<'T, IGQLError>,
                coerceOutput : obj -> 'T option,
                [<Struct>] ?description : string
            ) : ScalarDefinition<'T> = {
            Name = name
        ...
        static member Scalar
            (
                name : string,
                coerceInput : InputParameterValue -> Result<'T, IGQLError list>,
                coerceOutput : obj -> 'T option,
                [<Struct>] ?description : string
            ) : ScalarDefinition<'T> = {
            Name = name
        ...
        /// <param name="coerceOutput">Function used to cross cast to .NET types.</param>
        /// <param name="description">Optional scalar description. Usefull for generating documentation.</param>
        static member WrappedScalar
            (
                name : string,
                coerceInput : InputParameterValue -> Result<'Wrapper, string>,
                coerceOutput : obj -> 'Primitive option,
                [<Struct>] ?description : string
            ) : ScalarDefinition<'Primitive, 'Wrapper> = {
            Name = name
            Description = description
            CoerceInput =
                coerceInput
        ...
        static member WrappedScalar
            (
                name : string,
                coerceInput : InputParameterValue -> Result<'Wrapper, string list>,
                coerceOutput : obj -> 'Primitive option,
                [<Struct>] ?description : string
            ) : ScalarDefinition<'Primitive, 'Wrapper> = {
            Name = name
        ...
        static member WrappedScalar
            (
                name : string,
                coerceInput : InputParameterValue -> Result<'Wrapper, IGQLError>,
                coerceOutput : obj -> 'Primitive option,
                [<Struct>] ?description : string
            ) : ScalarDefinition<'Primitive, 'Wrapper> = {
            Name = name
        ...
        static member WrappedScalar
            (
                name : string,
                coerceInput : InputParameterValue -> Result<'Wrapper, IGQLError list>,
                coerceOutput : obj -> 'Primitive option,
                [<Struct>] ?description : string
            ) : ScalarDefinition<'Primitive, 'Wrapper> = {
            Name = name
        ...
        static member EnumValue
            (name : string, value : 'Val, [<Struct>] ?description : string, [<Struct>] ?deprecationReason : string)
            : EnumValue<'Val> = {
            Name = name
            Description = description
            Value = value
        ...
        static member Object
            (
                name : string,
                fields : FieldDef<'Val> list,
                [<Struct>] ?description : string,
                [<Struct>] ?interfaces : InterfaceDef list,
                [<Struct>] ?isTypeOf : obj -> bool
            ) : ObjectDef<'Val> =
            upcast
                {
        ...
        static member InputObject
            (name : string, fields : InputFieldDef list, validator : GQLValidator<'Out>, [<Struct>] ?description : string)
            : InputObjectDefinition<'Out> = {
            Name = name
            Description = description
            Fields = lazy (fields |> List.toArray)
            Validator = validator
        ...
        static member SubscriptionObject<'Val>
            (name : string, fields : SubscriptionFieldDef<'Val> list, [<Struct>] ?description : string)
            : SubscriptionObjectDefinition<'Val> = {
            Name = name
        ...
        static member AutoField
            (
                name : string,
                typedef : #OutputDef<'Res>,
                [<Struct>] ?description : string,
                [<Struct>] ?args : InputFieldDef list,
                [<Struct>] ?deprecationReason : string
            ) : FieldDef<'Val, 'Res> =
            upcast
                {
        ...
        /// </param>
        /// <param name="deprecationReason">Deprecation reason.</param>
        static member TaskSeqField
            (
                name : string,
                typedef : #OutputDef<'Item seq>,
        ...
        static member SubscriptionField
            (
                name : string,
                rootdef : #OutputDef<'Root>,
                outputdef : #OutputDef<'Output>,
        ...
        /// <param name="outputdef">GraphQL type definition of the current field's type.</param>
        /// <param name="filter">A filter function which decides if the field should be published to clients or not, by returning it as Some or None.</param>
        static member AsyncSubscriptionField
            (
                name : string,
                rootdef : #OutputDef<'Root>,
                outputdef : #OutputDef<'Output>,
        ...
        static member Input
            (name : string, typedef : #InputDef<'In>, [<Struct>] ?defaultValue : 'In, [<Struct>] ?description : string)
            : InputFieldDef =
            upcast
                {
                    InputFieldDefinition.Name = name
                    Description = description
                    IsSkippable = false
                    TypeDef = typedef
            ...
            upcast
                {
                    ...
                    Description =
                        description
                        |> ValueOption.map (fun s -> s + " Skip this field if you want to avoid saving it")
                    IsSkippable = true
                    TypeDef =
        ...
        static member Interface
            (name : string, fields : FieldDef<'Val> list, [<Struct>] ?description : string, [<Struct>] ?resolveType : obj -> ObjectDef)
            : InterfaceDef<'Val> =
            upcast
                {
        ...
        static member Union
            (
                ...
                resolveValue : 'In -> 'Out,
                [<Struct>] ?resolveType : 'In -> ObjectDef,
                [<Struct>] ?description : string
            ) : UnionDef<'In> =
            upcast
                {
    ...
    type DefineRec =
        ...
        /// <param name="description">Optional input object description. Useful for generating documentation.</param>
        static member InputObject
            (name : string, fieldsFn : unit -> InputFieldDef list, [<Struct>] ?description : string)
            : InputObjectDefinition<'Out> = {
            Name = name
        ...
        /// <param name="description">Optional input object description. Useful for generating documentation.</param>
        static member InputObject
            (name : string, fieldsFn : unit -> InputFieldDef list, validator : GQLValidator<'Out>, [<Struct>] ?description : string)
            : InputObjectDefinition<'Out> = {
            Name = name
            Fields = lazy (fieldsFn () |> List.toArray)
            Description = description
        ...
        /// <param name="resolveType">Optional function used to resolve actual Object definition of the .NET object provided as an input.</param>
        static member Interface
            (name : string, fieldsFn : unit -> FieldDef<'Val> list, [<Struct>] ?description : string, [<Struct>] ?resolveType : obj -> ObjectDef)
            : InterfaceDef<'Val> =
            upcast
                {
                    InterfaceDefinition.Name = name
