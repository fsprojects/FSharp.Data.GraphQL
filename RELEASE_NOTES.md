...
* **Breaking Change** `SubscriptionExecutionResult.Data` is now `obj Skippable`, and the record has new `Pending`, `Incremental`, `Completed` and `HasNext` fields for incremental delivery
