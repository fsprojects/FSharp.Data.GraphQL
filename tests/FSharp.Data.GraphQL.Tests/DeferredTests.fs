...
let ``Resolver error`` () =
    ...
    let expectedDeferred =
        DeferredErrors (
            null,
            [ GQLProblemDetails.Create ("Resolver error!", [ "testData"; "resolverError"; "value" ]) ],
...
let ``Nullable error`` () =
    ...
    let expectedDeferred =
        DeferredErrors (
            null,
            [ GQLProblemDetails.Create ("Non-Null field value resolved as a null!", [ "testData"; "nullableError"; "value" ]) ],
