...
module TestSchema =
    ...
    let planets = [
        { Id = "1"; Name = Some "Tatooine"; IsMoon = Some false }
        { Id = "2"; Name = Some "Endor"; IsMoon = Some true }
        { Id = "3"; Name = Some "Death Star"; IsMoon = Some false }
    ]
