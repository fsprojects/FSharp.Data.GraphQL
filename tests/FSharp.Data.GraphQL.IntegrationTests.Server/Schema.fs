...
module Schema =
            ...
            fields = [
                ...
                Define.Field (
                    ...
                    resolve =
                        fun _ _ ->
                            let extensions =
                                Dictionary<string, obj> ([ KeyValuePair ("code", box "OPERATION_ERROR_TEST"); KeyValuePair ("severity", box 7) ])
    ...
    let InputFileObject =
        Define.InputObject<InputFile> (name = "InputFile", fields = [ Define.Input ("file", FileType) ])
