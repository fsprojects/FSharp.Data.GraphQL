...
// Introspection response from the server
// This can be optionally used as a second parameter to the Provider
// If using this as a second parameter, connection to the server is not needed to
// compile the schema and have IntelliSense features when developing
[<Literal>]
let introspection = """{
  "documentId": 155787758,
  "data": {
    "__schema": {
      "queryType": {
        "name": "Query"
