...
// Persistence model
//
type Member_In_Db = { PrivId : MemberPrivateId; Id : MemberId; Name : string }

type ChatMember_In_Db = { ChatRoomId : ChatRoomId; MemberId : MemberId; Role : MemberRoleInChat }

type ChatRoom_In_Db = { Id : ChatRoomId; Name : string; Members : MemberId list }
...
// GraphQL models
//
type Member = { Id : MemberId; Name : string }

type MeAsAMember = { PrivId : MemberPrivateId; Id : MemberId; Name : string }

type ChatMember = { Id : MemberId; Name : string; Role : MemberRoleInChat }
...
type ChatRoom = { Id : ChatRoomId; Name : string; Members : ChatMember list }
